...
Author: Dima Ayman Ali
Date: April 2026
Description: A simple console game as part of my C++ learning roadmap.
*/
...
{
  //Green for player win,red + Alert for loss,yellow for draw
...
//helper function to handle screen indentation using tabs 
